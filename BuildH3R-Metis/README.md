# **Deploying a Decentralized Application on Metis Protocol using Scaffold.eth**

## **Overview**

This README outlines the process of deploying a decentralized application (dApp) on the **Metis Protocol** using the **Scaffold.eth** framework. In this example, the dApp is deployed on the **MetisSepolia** testnet, using **TMetis** tokens for gas fees.

## Deployed Contract Link

[Explorer](https://sepolia-explorer.metisdevops.link/address/0xc4cd0c0D4abA872ed1b688297Db599CfD92d8c48?tab=txs)

## **Prerequisites**

Before you begin, ensure you have the following:

1. **Node.js** [Node JS](https://nodejs.org/en/download/), **yarn** installed [Yarn](https://yarnpkg.com/getting-started/install) and [Git](https://git-scm.com/downloads).
2. **Metamask** or another compatible Ethereum wallet
3. **TMetis tokens** for gas fees on the MetisSepolia testnet
4. **Scaffold.eth** - an Ethereum-focused dApp development framework
5. **MetisSepolia** network added to your wallet
6. Basic understanding of smart contracts and Ethereum development
